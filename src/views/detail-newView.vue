...
import imgDetailNews1 from '@/assets/image/img-detailnews-1.jpg'
import imgDetailNews2 from '@/assets/image/img-detailnews-2.jpg'
...
<template>
  <div class="bg-[#0B121E] min-h-screen w-full">
    
    <div class="group p-1 pl-29">
      <router-link
        to="/forecast"
    ...
    <Transition name="fade-slide">
      <div
        v-if="show"
        class="pl-26 pr-25 bg-[#0B121E] w-full"
      >
